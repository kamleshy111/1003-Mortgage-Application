...
function mortgage_application_enqueue_scripts()
{
	/*add css file*/
	wp_enqueue_style('ma_css', MORTGAGE_APP_BASE_URL . 'assets/css/style.css', array('style'), '1.0.0', 'all' );
    /*add js file*/
	wp_enqueue_script('ma_js', MORTGAGE_APP_BASE_URL . 'assets/js/ma.js', array('jquery'), '1.0.0', 'true' );
}
/* include classes. */
